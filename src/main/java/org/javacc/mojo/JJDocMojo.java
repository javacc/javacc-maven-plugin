 ...
 * specification and produces documentation for the BNF grammar.<br>
 * This mojo will search the source directory for all <code>*.jj</code> files and run JJDoc once for
 * each file it finds.<br>
...
public class JJDocMojo extends AbstractMavenReport {
  ...
  /**
   * The directories where the JavaCC grammar files (<code>*.jj</code>) are located.<br>
   * By default, the directories <code>${basedir}/src/main/javacc</code>, <code>
   * ${project.build.directory}/generated-sources/jjtree</code> and <code>
   * ${project.build.directory}/generated-sources/jtb</code> are scanned for grammar files to
   * document. A plugin parameter.
   *
   * @parameter
   */
  ...
  /**
   * The default source directory for hand-crafted JavaCC grammar files.<br>
  ...
  /**
   * The default source directory for grammar files generated by JJTree.<br>
   * Default value is <code>${project.build.directory}/generated-sources/jjtree</code>. A plugin
   * parameter.
   *
  ...
  /**
   * The default source directory for grammar files generated by JTB.<br>
   * Default value is <code>${project.build.directory}/generated-sources/jtb</code>. A plugin
   * parameter.
   *
  ...
  /**
   * The relative path of the JJDoc reports in the output directory.<br>
   * This path will be appended to the output directory.<br>
   * Default value is <code>jjdoc</code>. A plugin parameter.
   *
  ...
  /**
   * The destination directory where JJDoc saves the generated documentation files.<br>
   ...
   * the Maven Site Plugin is used instead.<br>
   * Default value is <code>${project.reporting.outputDirectory}</code>. A plugin parameter.
   *
   ...
   * Default value is <code>project.build.sourceEncoding</code>. A JJDoc option.
   *
  ...
  /**
   * The hypertext reference to an optional CSS file for the generated HTML documents.<br>
   * If specified, this CSS file will be included via a <code>&lt;link&gt;</code> element in the
   * HTML documents.<br>
   * Otherwise, the JJDoc default style will be used. A JJDoc option.
   *
  ...
  /**
   * A flag to specify the output format for the generated documentation.<br>
   * If set to <code>true</code>, JJDoc will generate a plain text description of the BNF.<br>
   * Some formatting is done via tab characters, but the intention is to leave it as plain as
   * possible.<br>
   * Specifying <code>false</code> causes JJDoc to generate a hyperlinked HTML document unless the
   * parameter {@link #bnf} has been set to <code>true</code>.<br>
   * Default value is <code>false</code>. A JJDoc option.
   *
  ...
  /**
   * A flag whether to generate a plain text document with the unformatted BNF.<br>
   * Note that setting this option to <code>true</code> is only effective if the parameter {@link
   * #text} is <code>false</code>.<br>
   * Default value is <code>false</code>. A JJDoc option.
   *
  ...
  /**
   * This option controls the structure of the generated HTML output.<br>
   * If set to <code>true</code> (the default value), a single HTML table for the entire BNF is
   * generated.<br>
   * Otherwise, the default value, it will produce one table for every production in the grammar. A
   * JJDoc option.
   *
   ...
   *
   * @return The source directories that should be scanned for grammar files, never <code>null
   *     </code>.
   */
   ...
   * @return <code>true</code> if the configured source directories are not empty, <code>false
   *     </code> otherwise.
   */
  @Override
  public boolean canGenerateReport() {
    ...
    for (int i = 0; i < sourceDirs.length; i++) {
      final File sourceDir = sourceDirs[i];
  ...
  public void executeReport(final Locale locale) throws MavenReportException {
    ...
    for (int j = 0; j < sourceDirs.length; j++) {
      final File sourceDir = sourceDirs[j];
      ...
      if (grammarInfos == null) {
        ...
        for (int i = 0; i < grammarInfos.length; i++) {
          final GrammarInfo grammarInfo = grammarInfos[i];
  ...
  private void createReportLink(
      final Sink sink, final File sourceDirectory, final File grammarFile, String linkPath) {
    sink.tableRow();
    sink.tableCell();
  ...
  /**
   * Creates a new facade to invoke JJDoc.<br>
   * Most options for the invocation are derived from the current values of the corresponding mojo
   * parameters.<br>
   * The caller is responsible to set the input file and output file on the returned facade.
   *
  ...
  private JJDoc newJJDoc() {
    ...
    jjdoc.setLog(getLog());
    jjdoc.setGrammarEncoding(grammarEncoding);
    jjdoc.setCssHref(cssHref);
    jjdoc.setText(text);
    jjdoc.setBnf(bnf);
    jjdoc.setOneTable(Boolean.valueOf(oneTable));
    return jjdoc;
  }
  ...
  private GrammarInfo[] scanForGrammars(final File sourceDirectory) throws MavenReportException {
    ...
    try {
      final String[] includes = {
        "**/*.jj", "**/*.JJ", "**/*.jjt", "**/*.JJT", "**/*.jtb", "**/*.JTB"
      };
      final GrammarDirectoryScanner scanner = new GrammarDirectoryScanner(getLog());
  ...
  private static class GrammarInfoComparator implements Comparator<Object> {
