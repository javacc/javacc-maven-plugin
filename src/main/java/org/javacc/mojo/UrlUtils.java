...
class UrlUtils {
  ...
  /**
   * Gets the absolute filesystem path to the class path root for the specified resource.<br>
   * The root is either a JAR file or a directory with loose class files.<br>
   * If the URL does not use a supported protocol, an exception will be thrown.
   *
   ...
   * @return The absolute filesystem path to the class path root of the resource or <code>null
   *     </code> if the input URL was <code>null</code>.
   */
   ...
   * by decoding with the UTF-8 character set.<br>
   * This function is primarily intended for usage with {@link java.net.URL} which unfortunately
   * does not enforce proper URLs.<br>
   * As such, this method will leniently accept invalid characters or malformed percent-encoded
   * octets and simply pass them literally through to the result string.<br>
   * Except for rare edge cases, this will make unencoded URLs pass through unaltered.
   *
